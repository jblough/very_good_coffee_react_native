...
- On app initialization, if there is a local image saved, that should be used instead of pulling from the api
- Real app package (currently "com.anonymous.myapp")
- app icon
